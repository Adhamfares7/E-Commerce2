...
export default function Register() {
 async function handelRegister(values) {
  ...
  axios.post('http://fake-shop-api.ap-south-1.elasticbeanstalk.com/app/v1/users', )
      ...
      >
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            id="username"
            className="block py-2.5 px-0 w-full text-sm border-b-2 border-gray-300 text-white bg-transparent appearance-none  focus:outline-none focus:ring-0 focus:border-red-600 peer"
            placeholder=""
            required
          />
          <label
            htmlFor="username"
            className="peer-focus:font-medium left-0 absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
            UserName
          </label>
